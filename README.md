...
- **Framework-agnostic core** with a Vue 3 adapter (`@eremitejs/eremite/vue`). React and others are a thin `subscribe` bridge away.
...
```ts
import { collection, createStore } from '@eremitejs/eremite'
...
import { useQuery, usePull, useSyncStatus } from '@eremitejs/eremite/vue'
